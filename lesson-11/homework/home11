...
select a.orderid,b.FirstName,a.orderdate from Orders as a
left join Customers as b
on a.customerid=b.customerid
where a.OrderDate>'01.01.2022'
...
select a.Departmentname,max(b.salary) from Departments a
join Employees b
on a.DepartmentID=b.DepartmentID
group by a.Departmentname

select a.firstname,b.orderid,b.orderdate from customers as a
join orders b
on a.CustomerID=b.CustomerID
where a.city like 'usa' and b.orderdate>='01.01.2023' and b.orderdate<='31.12.2023' 

select a.firstname,count(b.orderid) from customers a 
join orders b
on a.customerid=b.customerid
...
select a.firstname,sum(b.TotalAmount) from Customers a
join orders b
on a.CustomerID=b.CustomerID
where b.TotalAmount>500
group by a.FirstName


select a.productname,b.saledate,b.saleamount from products a join sales b
on a.ProductID=b.ProductID
where b.SaleDate>='2022-01-01' and b.SaleDate<='2022-12-31' or b.SaleAmount>400


select a.PRODUCTname,sum(b.saleamount) from products a join sales b
on a.ProductID=b.ProductID
...
select a.name,b.departmentname,a.salary from Employees a
join departments as b
on a.DepartmentID=b.DepartmentID
where b.departmentname like 'hr' and a.salary>60000


select a.productname,b.saledate,a.stockquantity from Products as a join sales as b
on a.ProductID=b.ProductID
where b.saledate>='2023-01-01' and b.saledate<='2023-12-31' and a.stockquantity>100


select a.name,b.DepartmentName,a.hiredate from Employees a join Departments b
on a.DepartmentID=b.DepartmentID
where b.DepartmentName like 'sales' or a.hiredate>'2020-01-01'

select*from Departments
select*from Products

select a.firstname,b.orderid,a.address,b.orderdate from Customers a join orders b
on a.CustomerID=b.CustomerID
where a.Country='usa' and a.address like '4%'


select a.productname,a.category,b.saleamount from Products a join sales b
on a.ProductID=b.ProductID
join Categories c
on a.Category=c.categoryid
where c.CategoryName='electronics' or b.saleamount>350

select a.categoryname,count(b.productid) from Categories a join Products b
on a.CategoryID=b.Category
