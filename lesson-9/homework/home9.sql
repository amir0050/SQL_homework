...
select a.name,b.coursename from students as a
join Enrollments as c 
on a.StudentID=c.StudentID
join courses as b
on c.courseid=b.courseid


select a.productname,b.OrderID,b.orderdate from products as a
join orders as b
...
select orders.OrderID,orders.OrderDate,PaymentID,Payments.Amount from Orders
join Payments
on orders.OrderID=Payments.OrderID

select o.*,p.Price from orders as o
join products as p
...
select b.OrderID,b.Quantity,a.StockQuantity from products as a
join orders as b
on a.ProductID=b.ProductID
where b.Quantity>a.StockQuantity



select a.FirstName,b.productid,b.saleamount from Customers as a join sales as b
on a.CustomerID=b.CustomerID
...
select a.productid,a.productname,b.suppliername from Products as a 
join Suppliers as b
on a.SupplierID=b.SupplierID
where b.SupplierName like '%tech%'

select a.orderid,b.amount,a.totalamount from orders as a
join payments as b
...
select a.productid,a.productname,b.CategoryName from Products as a 
join Categories as b
on a.Category=b.CategoryID
where b.CategoryName in ('electronics', 'furniture')

select a.firstname,a.country,b.saleid,b.saleamount from Customers as a
join sales as b
on a.CustomerID=b.CustomerID
...
select a.firstname,a.country,b.OrderID,b.OrderDate from Customers as a
join Orders as b
on a.CustomerID=b.CustomerID
where a.country like 'germany'
